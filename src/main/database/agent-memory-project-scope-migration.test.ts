...
const MANAGED_FILE_VERSION_MIGRATION_ID = '0025_managed_file_version_foundation'
const CURRENT_MIGRATION_ID = '0026_agent_result_delivery'
...
describe('agent memory project scope migration', () => {
  ...
  it('replays an unledgered partial memory migration and restores missing triggers', async () => {
    ...
    await client.$executeRawUnsafe(
      ...
      MANAGED_FILE_VERSION_MIGRATION_ID,
