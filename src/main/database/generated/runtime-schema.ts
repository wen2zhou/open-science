...
const RUNTIME_SCHEMA_TABLE_DDLS = [
  ...
  `CREATE TABLE IF NOT EXISTS "ComputeJob" (
    ...
    CONSTRAINT "ComputeJob_remoteObjectEvidenceJson_check" CHECK ("remoteObjectEvidence" IS NULL OR (json_valid("remoteObjectEvidence") AND json_type("remoteObjectEvidence") = 'array')),
    CONSTRAINT "ComputeJob_cleanupReceiptJson_check" CHECK ("cleanupReceipt" IS NULL OR (json_valid("cleanupReceipt") AND json_type("cleanupReceipt") = 'object'))
);`,
  `CREATE TABLE IF NOT EXISTS "ComputeJobRemoteReference" (
    "id" TEXT NOT NULL PRIMARY KEY,
  ...
  `CREATE TABLE IF NOT EXISTS "ComputeJobOperation" (
    ...
    CONSTRAINT "ComputeJobOperation_kind_check" CHECK ("kind" IN ('cancel', 'cleanup')),
    ...
    CONSTRAINT "ComputeJobOperation_receiptJson_check" CHECK ("receipt" IS NULL OR (json_valid("receipt") AND json_type("receipt") = 'object'))
);`,
