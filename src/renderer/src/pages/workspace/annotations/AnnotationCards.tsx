          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0 flex-1">
                <div className="font-medium text-foreground">{t('Text quote')}</div>
                <div className="mt-0.5 line-clamp-2 break-words text-muted-foreground">
                  {annotation.kind === 'text' ? annotation.quote : annotation.source.name}
                </div>
                <div className="mt-1 text-[11px] text-muted-foreground">
                  {t('Source: {{source}}', { source: annotationSourceLabel(annotation, t) })}
                </div>
                {annotation.note ? <div className="mt-1 break-words">{annotation.note}</div> : null}
              </div>
              <Tooltip>
                <TooltipTrigger
                  asChild
