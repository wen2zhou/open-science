...
export const WEB_INVOKE_CHANNELS = {
  ...
  'acp.setSessionSpecialist': 'acp:set-session-specialist',
  ...
  'settings.createSpecialist': 'settings:create-specialist',
  'settings.deleteProvider': 'settings:delete-provider',
  'settings.deleteSkill': 'settings:delete-skill',
  'settings.deleteSpecialist': 'settings:delete-specialist',
  ...
  'settings.duplicateSpecialist': 'settings:duplicate-specialist',
  ...
  'settings.listSpecialists': 'settings:list-specialists',
  ...
  'settings.setSpecialistEnabled': 'settings:set-specialist-enabled',
  ...
  'settings.updateSpecialist': 'settings:update-specialist',
  'settings.upsertProvider': 'settings:upsert-provider',
  'settings.validateProvider': 'settings:validate-provider',
  'specialists.callTool': 'specialists:call-tool',
  'specialists.cancelMutation': 'specialists:cancel-mutation',
  'specialists.confirmMutation': 'specialists:confirm-mutation',
  'specialists.stageMutation': 'specialists:stage-mutation',
...
export const WEB_EVENT_CHANNELS = {
  ...
  'specialists.onChanged': 'specialists:changed',
