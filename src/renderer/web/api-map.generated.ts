...
export const WEB_INVOKE_CHANNELS = {
  ...
  'compute.environmentCreate': 'compute:environment:create',
  'compute.environmentDelete': 'compute:environment:delete',
  'compute.environmentRecordValidation': 'compute:environment:record-validation',
  'compute.environmentsList': 'compute:environments:list',
  'compute.environmentUpdate': 'compute:environment:update',
